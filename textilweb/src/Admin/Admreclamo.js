...
const Admreclamo = () => {
    ...
    const fetchData = async () => {
        ...
        if (data1[0].CliReclamos.length === 0) {
            alert("El cliente no tiene reclamos registrados.")
    ...
    const guardar_respuesta = async (var_id, var_titulo, var_fecha) => {
        ...
        if (formularioValido && formularioValido2) {
            ...
            fetch("http://localhost:5000/apiadminclientes/" + var_id, requestOptions)
                    ...
                    <div class="checkout__form">
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-8">
                                ...
                                <div class="col-lg-6">
                                    <button class="site-btn" id="btn_regresar" onClick={() => regresar()}>Regresar</button>
                                </div>
                            </div>
