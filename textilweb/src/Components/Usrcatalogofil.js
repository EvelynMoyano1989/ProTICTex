...
const Usrcatalogofil = () => {
    ...
    const FetchDataini = async () => {
        ...
        const resp = await fetch("http://localhost:5000/apilistpedidos//" + dato_nombre + "/" + filtro + "/" + dato_color + "/" + dato_modelo);
